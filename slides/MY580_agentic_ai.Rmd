...
Where are you? A **highly opinionated introduction** to agentic AI for social science and data science research.
...
The goal is to get you **off the ground**, not to provide a perfect recipe.
...
Materials are on [GitHub here](https://github.com/ddekadt/MY580_agentic_ai). Fork or clone to follow along.
...
<div style="text-align: center; margin-top: 0.8em;"><em>Exhibit A: Sycophancy in action</em></div>
...
AI companies lean into this. One of the most prominent labs is literally called **Anthropic**!
...
- **Tier 5**: Validation, cross-checking, and adversarial reviews built into your workflow.
--
...
A **CLI** is a text-based way of sending commands to your computer. We will use this workflow for CLI agents today:
...
See you back at 1pm London time.
...
- `Good catch, let me revise that` -- after you flagged something that was actually fine

--

**Compliance** -- the agent does what you asked, even when what you asked is a bad idea:

- *"Just hard-code that value for now"* -- and it does, never to return
...
<img src="images/tiny_plunger.jpg" alt="Cartoon: a tiny plunger suggested as the answer to a much bigger problem -- a confidently-wrong recommendation." style="max-width: 100%; max-height: 470px;" />

<div style="text-align: center; margin-top: 0.8em;"><em>Exhibit B: Being confidently wrong</em></div>
...
A deeper trap: **agent dependence** and **addiction** (I do not use this word lightly). 
...
Take your morning project and apply today's lessons. Quality, rigour, catch mistakes.
